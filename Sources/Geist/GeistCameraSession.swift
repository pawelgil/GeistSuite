...
public protocol GeistCameraSessionDelegate: AnyObject, Sendable {
    func sessionDidConnect(_ session: GeistCameraSession)
    func sessionDidDisconnect(_ session: GeistCameraSession)
    func session(_ session: GeistCameraSession, didActivateSlotWithoutSource slot: CameraSlot)
    func session(_ session: GeistCameraSession, isStreamingChanged isStreaming: Bool)
}
...
public extension GeistCameraSessionDelegate {
    func sessionDidConnect(_ session: GeistCameraSession) {}
    func sessionDidDisconnect(_ session: GeistCameraSession) {}
    func session(_ session: GeistCameraSession, didActivateSlotWithoutSource slot: CameraSlot) {}
    func session(_ session: GeistCameraSession, isStreamingChanged isStreaming: Bool) {}
...
/// ```swift
/// let session = GeistCameraSession(delegate: self)
...
public actor GeistCameraSession: SessionDriving {
    public enum State: Sendable { case idle, listening, connected, stopped }

    public private(set) weak var delegate: (any GeistCameraSessionDelegate)?
    ...
    public init(delegate: (any GeistCameraSessionDelegate)? = nil,
    ...
    public init(socketPath: String,
                delegate: (any GeistCameraSessionDelegate)? = nil,
                shimDylibPath: String? = nil, shimLogPath: String? = nil) {
    ...
    public nonisolated func injectionEnv() -> [String: String] {
        let dylib = shimDylibPath
            ...
            ?? GeistShimBundled.cameraShimDylibPath
    ...
    public func attach(_ source: CameraSource, to slot: CameraSlot) async throws(SourceSwitchError) {
    ...
    private func makeProducer(for source: CameraSource, slot: CameraSlot) async -> AnyProducer? {
